    ...
    <div className="bg-cinder-0 pt-12 font-sans font-semibold flex justify-center">
      <div className="max-w-screen-lg w-full flex flex-col space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          {/* Card 1: Farm to Cup */}
          <div className="bg-[#144939] w-72 md:w-64 border-4 border-black shadow-md rounded-3xl p-8 text-center transform md:-translate-x-6">
          ...
          <div className="bg-[#144939] w-72 md:w-64 border-4 border-black shadow-md rounded-3xl z-20 text-center p-8">
            <p className="text-canaryYellow-0 text-2xl md:text-3xl mb-4">
              Instant Settlements
            </p>
            <p className="text-white text-lg md:text-2xl">
