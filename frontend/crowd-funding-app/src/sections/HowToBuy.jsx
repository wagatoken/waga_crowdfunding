...
const HowToBuy = () => {
  return (
    <div className="min-h-screen bg-cinder-0 flex justify-center items-center py-10">
      <div className="h-2/3 w-11/12 md:w-2/3 flex flex-col">
        {/* Top Section */}
        ...
        <div className="flex flex-col md:flex-row h-3/5 gap-6 mt-6">
          ...
          <div className="flex-1 flex flex-col items-center gap-6">
            <div className="bg-[#0F2C23] rounded-3xl text-white text-sm p-6 min-h-[60%] leading-relaxed">
          ...
          {/* Steps Section */}
          <div className="w-full md:w-2/3 bg-[#0F2C23] rounded-3xl">
            <StepCard />
          </div>
        </div>
      </div>
